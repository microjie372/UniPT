...
class Detector3DTemplate_UniPT(nn.Module):
    def __init__(self, model_cfg, num_class, num_class_s2, dataset, dataset_s2, source_one_name):
        ...
        self.module_topology = [
            'vfe', 'backbone_3d', 'map_to_bev_module', 'backbone_2d', 'dense_2d_moe',
            'dense_head_s1', 'dense_head_s2',
        ]
...
class Detector3DTemplate_UniPT_DB_3(nn.Module):
    def __init__(self, model_cfg, num_class, num_class_s2, num_class_s3, dataset, dataset_s2, dataset_s3, source_one_name, source_1):
        ...
        self.module_topology = [
            'vfe', 'backbone_3d', 'map_to_bev_module', 'backbone_2d', 'dense_2d_moe',
            'dense_head_s1', 'dense_head_s2', 'dense_head_s3',
        ]
