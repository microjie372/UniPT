...
from .unipt_net import UniPT, UniPT_DB_3
...
__all__ = {
    ...
    'Detector3DTemplate_UniPT': Detector3DTemplate_UniPT,
    'Detector3DTemplate_UniPT_DB_3': Detector3DTemplate_UniPT_DB_3,
    'SECONDNet': SECONDNet,
    'PartA2Net': PartA2Net,
    'PVRCNN': PVRCNN,
