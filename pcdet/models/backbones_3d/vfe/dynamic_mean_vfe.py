...
class DynamicMeanVFE(VFETemplate):
    def __init__(self, model_cfg, num_point_features, voxel_size, grid_size, point_cloud_range, **kwargs):
        ...
        self.voxel_size_bev = torch.tensor(voxel_size_bev).cuda()
        ...
        self.voxel_x_bev = voxel_size_bev[0]
        self.voxel_y_bev = voxel_size_bev[1]
        self.voxel_z_bev = voxel_size_bev[2]
    ...
    def forward(self, batch_dict, **kwargs):
        ...
        batch_dict['voxel_num_points'] = unq_cnt.contiguous()
        return batch_dict
