...
from pcdet.datasets import DatasetTemplate, build_dataloader_mdf
from pcdet.models import build_network, build_network_multi_db, load_data_to_gpu
...
def main():
    ...
    model = build_network_multi_db(model_cfg=cfg.MODEL, num_class=len(cfg.CLASS_NAMES), dataset=demo_dataset)
